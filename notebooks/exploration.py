...
# Analyse du nombre de patients par sexe et par diagnostic
analyse_groupee = df.groupby(["sexe", "diagnostic"]).size()

print("--- Répartition par sexe et diagnostic ---")
print(analyse_groupee)
